...
export default function ScraperTester() {
 ...
 text-teal-900 font-medium hover:opacity-90 disabled:opacity-60 hover:shadow hover:shadow-green-800 hover:scale-[101%] active:shadow-none active:scale-[100%]"
                    ...
                    {/* Result Tabs */}
                    <div className="w-full max-w-5xl mt-10 z-10">
                        <div className="flex justify-between">
                            ...
                            <Link href="/dashboard" className="flex justify-center items-center px-4 py-2 bg-black text-white rounded-xl cursor-pointer">Check Usage</Link>
                        </div>
